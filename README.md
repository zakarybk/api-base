...
* I have been able to get Xunit working with dotnet test, however I get permission errors in api (non-base) from file access issues https://github.com/zakarybk/api/tree/1.5.0-mono-only
